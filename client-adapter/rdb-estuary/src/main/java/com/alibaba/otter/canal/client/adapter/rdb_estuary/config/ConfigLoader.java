...
public class ConfigLoader {
    ...
    public static Map<String, MappingConfig> load(Properties envProperties) {
        logger.info("## Start loading rdb-estuary mapping config ... ");

        Map<String, MappingConfig> result = new LinkedHashMap<>();

        Map<String, String> configContentMap = MappingConfigsLoader.loadConfigs("rdb-estuary");
        ...
        logger.info("## rdb-estuary mapping config loaded");
        return result;
    }
}
